...
namespace UnityInterception
{
    ...
    public class AppLog : IInterceptionBehavior
    {
        ...
        public IMethodReturn Invoke(IMethodInvocation input, GetNextInterceptionBehaviorDelegate getNext)
        {
            ...
            {
                Console.WriteLine($"呼叫這個方法之前：{input.MethodBase.DeclaringType.Name}.{input.MethodBase.Name}");
                result = getNext()(input, getNext);
                Console.WriteLine($"呼叫這個方法之後：{input.MethodBase.DeclaringType.Name}{input.MethodBase.Name}");
                return result;
            }
